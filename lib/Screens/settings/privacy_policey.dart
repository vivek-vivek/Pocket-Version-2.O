...
Google Play Services""",
      ...
      * To assist us in analyzing how our Service is used.
      I want to inform users of this Service that these third parties have access to their Personal Information. The reason is to perform the tasks assigned to them on our behalf. However, they are obligated not to disclose or use the information for any other purpose.""", style: GoogleFonts.lato(
                      fontSize: 20, fontWeight: FontWeight.w500)),
              //^  heading - Contact Us
              Text("Contact Us",
                  style: GoogleFonts.lato(
      ...
      This privacy policy page was created at privacypolicytemplate.net and modified/generated by App Privacy Policy Generator""", style: GoogleFonts.lato(
                      fontSize: 20, fontWeight: FontWeight.w500))
            ],
          ),
        ),
